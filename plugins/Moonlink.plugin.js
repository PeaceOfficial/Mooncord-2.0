 ...
 * @updateUrl https://raw.githubusercontent.com/PeaceOfficial/Moonlink/refs/heads/main/Moonlink.plugin.js
    ...
    async fakeAvatarDecorations() {
        ...
        Patcher.after(this.meta.name, UserStore, "getUser", (_, args, ret) => {
            ...
            if (ret.avatarDecorationData == undefined || ret.avatarDecorationData?.asset != avatarDecorations[assetId]) {
                ...
                //add user to the list of users to show with the Moonlink user badge if we haven't already.
