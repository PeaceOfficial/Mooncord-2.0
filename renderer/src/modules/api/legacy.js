...
/**
 * Enables a Mooncord setting by IDs.
 * 
 * @deprecated
 * @param {string} [collection="settings"] Collection ID
 * @param {string} category Category ID in the collection
...
/**
 * Disables a Mooncord setting by IDs.
 * 
 * @deprecated
 * @param {string} [collection="settings"] Collection ID
 * @param {string} category Category ID in the collection
...
/**
 * Toggles a Mooncord setting by IDs.
 * 
 * @deprecated
 * @param {string} [collection="settings"] Collection ID
 * @param {string} category Category ID in the collection
...
/**
 * Gets some data in Mooncord's misc data.
 * 
 * @deprecated
...
/**
 * Sets some data in Mooncord's misc data.
 * 
 * @deprecated
